...
const dmy2str = ({d, m, y}) => ((((d < 10) && '0' + d)|| d ) + '/' +  (((m < 10) && '0' + m)|| m ) + '/' +  y)
...
export {    daysInMonth, isLeapYear, str2dmy, dmy2str, 
            date2str, date2dmy, str2date, 
            isValideDate, dateFormater, months, 
            days, addMonth, subMonth, addYear, subYear }